...
class BMIResult extends StatelessWidget {
  ...
  BMIResult({@required this.tinggi_badan, @required this.berat_badan, @required this.nama_lengkap, @required this.tahun_lahir, @required this.bulan_lahir, @required this.tanggal_lahir, @required this.jeniskelamin});
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            new Text(
              "Tanggal Lahir : ${tanggal_lahir} - ${bulan_lahir} - ${tahun_lahir} ",
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.w300,
                color: Colors.black,
            ...
            new Text(
              "Umur Anda : ${2020 - tahun_lahir} Tahun",
              style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.w300,
                  color: Colors.black87
